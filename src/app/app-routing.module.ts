...
const routes: Routes = [
  ...
  { path: 'datasets/:id/projects/:projectId', component: DataSetDetailComponent },
  { path: 'datasets/:id/projects/:projectId/instances/:instanceId', component: DataSetDetailComponent },
];
